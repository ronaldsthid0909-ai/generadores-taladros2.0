...
st.markdown(
    ...
    <style>
        ...
        /* TEXTOS, TÍTULOS Y ETIQUETAS EN LA BARRA LATERAL (SIEMPRE VISIBLES Y BLANCOS) */
        ...
        /* ÚNICAMENTE LOS CUADROS EDITABLES (NUMERIC INPUTS) */
        ...
        /* BOTONES DE MAS (+) Y MENOS (-) DENTRO DE LOS INPUTS */
...
# Layout: Gráfica (4 cols) | Métricas y Criterio (2 cols)
